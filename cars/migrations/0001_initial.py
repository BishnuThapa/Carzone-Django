# Generated by Django 4.1 on 2022-08-13 01:48
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.CharField(choices=[('Madhesh Province', 'Madhesh Province'), ('Bagmati Province', 'Bagmati Province'), ('Lumbini Province', 'Lumbini Province'), ('\tProvince No. 1', '\tProvince No. 1'), ('Sudurpashchim Province', 'Sudurpashchim Province'), ('Gandaki Province', 'Gandaki Province'), ('Karnali Province', 'Karnali Province')], max_length=100)),
